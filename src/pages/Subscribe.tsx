...
export function Subscribe() {
  ...
  return (
    <div className="min-h-screen  bg-blur bg-cover bg-no-repeat flex flex-col items-center">
        ...
        <div className="p-8 bg-gray-700 border border-gray-500 rounded">
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col gap-2 w-full">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 bg-green-500 uppercase rounded py-4 font-bold txt-sm hover:bg-green-700 transition-colors disabled:opacity-50"
            >
              Garantir minha vaga
            </button>
          </form>
      ...
      <img src="/src/assets/coldMockup.png" alt="" className="mt-10 " />
    </div>
  );
}
function useCreateSubscribeMutation(): [any, { loading: any }] {
